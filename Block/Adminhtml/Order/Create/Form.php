<?php
namespace CSSoft\CheckoutDetails\Block\Adminhtml\Order\Create;
...
class Form extends \Magento\Sales\Block\Adminhtml\Order\Create\Form\AbstractForm
{
     ...
     * @param \CSSoft\CheckoutDetails\Model\ResourceModel\Field\Value\CollectionFactory $fieldValueCollectionFactory
     * @param array $data
    ...
    public function __construct(
        ...
        \CSSoft\CheckoutDetails\Model\ResourceModel\Field\Value\CollectionFactory $fieldValueCollectionFactory,
        array $data = []
    ) {
    ...
    {
        return 'head-cssoft-checkout-fields';
    }
    ...
    protected function _prepareForm()
    {
        ...
        $this->_form->addFieldNameSuffix('order[cssoft_checkout_fields]');
     ...
     *
     * @param \CSSoft\CheckoutDetails\Model\Field[] $fields
