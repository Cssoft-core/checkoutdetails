<?php
namespace CSSoft\CheckoutDetails\Block\Adminhtml\Field;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('CSSoft_CheckoutDetails::save')) {
        ...
        if ($this->_isAllowedAction('CSSoft_CheckoutDetails::delete')) {
