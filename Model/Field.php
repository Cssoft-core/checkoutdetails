<?php
namespace CSSoft\CheckoutDetails\Model;

use CSSoft\CheckoutDetails\Api\Data\FieldInterface;
...
class Field extends \Magento\Framework\Model\AbstractModel implements FieldInterface, IdentityInterface
{
     ...
     * Source instance
     *
     * @var \CSSoft\CheckoutDetails\Model\ResourceModel\Field\Option\Collection
     */
    protected $source;

    /**
     * Checkout field options collection factory
     * @var \CSSoft\CheckoutDetails\Model\ResourceModel\Field\Option\CollectionFactory
     */
     ...
     * @param \CSSoft\CheckoutDetails\Model\ResourceModel\Field\Option\CollectionFactory $fieldOptionsCollectionFactory
    ...
    public function __construct(
        ...
        \CSSoft\CheckoutDetails\Model\ResourceModel\Field\Option\CollectionFactory $fieldOptionsCollectionFactory,
    ...
    {
        $this->_init('CSSoft\CheckoutDetails\Model\ResourceModel\Field');
    }
     ...
     *
     * @param int $fieldId
     * return \CSSoft\CheckoutDetails\Api\Data\FieldInterface
     */
     ...
     *
     * @return \CSSoft\CheckoutDetails\Model\ResourceModel\Field\Option\Collection
     */
