...
use CSSoft\CheckoutDetails\Api\Data\FieldValueInterface;
...
class Value extends AbstractModel implements FieldValueInterface, IdentityInterface
{
     ...
     * cache tag
     */
    const CACHE_TAG = 'cssoft_checkout_field_value';

    /**
     * @var string
     */
    protected $_cacheTag = 'cssoft_checkout_field_value';
     ...
     * @var string
     */
    protected $_eventPrefix = 'cssoft_checkout_field_value';
    ...
    {
        $this->_init('CSSoft\CheckoutDetails\Model\ResourceModel\Field\Value');
    }
