<?php
namespace CSSoft\CheckoutDetails\Model\ResourceModel\Field\Value;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init('CSSoft\CheckoutDetails\Model\Field\Value', 'CSSoft\CheckoutDetails\Model\ResourceModel\Field\Value');
    }
    ...
    protected function joinFieldInfo()
    {
        ...
        $this->getSelect()->joinLeft(
            ['fi' => $this->getTable('cssoft_checkoutdetails_field')],
    ...
    public function addStoreLabel($storeId)
    {
        ...
        $this->getSelect()->joinLeft(
            ['fl' => $this->getTable('cssoft_checkoutdetails_field_label')],
            $joinExpression,
