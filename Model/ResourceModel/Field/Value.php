...
class Value extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('cssoft_checkoutdetails_values', 'value_id');
    }

    /**
     * Load by quoteId, fieldId and storeId
     *
     * @param \CSSoft\CheckoutDetails\Model\Field\Value $fieldValue
     * @param int $quoteId
     * @param int $fieldId
     * @param int $storeId
     * @return $this
    ...
    public function loadByQuoteFieldAndStore(
        \CSSoft\CheckoutDetails\Model\Field\Value $fieldValue,
        $quoteId,
        $fieldId,
        $storeId
    ) {
