...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init('CSSoft\CheckoutDetails\Model\Field', 'CSSoft\CheckoutDetails\Model\ResourceModel\Field');
    ...
    protected function performAfterLoad($tableName, $linkField)
    {
        ...
        if (count($linkedIds)) {
            ...
            $select = $connection->select()->from(['cssoft_checkoutdetails_store' => $this->getTable($tableName)])
                ->where('cssoft_checkoutdetails_store.' . $linkField . ' IN (?)', $linkedIds);
    ...
    {
        $this->performAfterLoad('cssoft_checkoutdetails_store', 'field_id');
    ...
    {
        $this->joinStoreRelationTable('cssoft_checkoutdetails_store', 'field_id');
    }
