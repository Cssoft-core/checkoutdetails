<?php
namespace CSSoft\CheckoutDetails\Model\ResourceModel\Field\Option;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init(
            'CSSoft\CheckoutDetails\Model\Field\Option',
            'CSSoft\CheckoutDetails\Model\ResourceModel\Field\Option'
        );
        $this->_optionValueTable = $this->_coreResource->getTableName('cssoft_checkoutdetails_field_option_value');
    }
    ...
    {
        return $this->addFieldToFilter('field_id', $setId);
    }
     ...
     * @return array
     */
    public function getAllOptions($valueKey = 'value')
    {
