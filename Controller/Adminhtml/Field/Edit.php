<?php
namespace CSSoft\CheckoutDetails\Controller\Adminhtml\Field;
...
class Edit extends \Magento\Backend\App\Action
{
     ...
     * Admin resource
     */
    const ADMIN_RESOURCE = 'CSSoft_CheckoutDetails::checkoutfields';
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('CSSoft_CheckoutDetails::checkoutfields')
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('CSSoft\CheckoutDetails\Model\Field');
